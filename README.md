...
<sup id="f1"> 1 </sup> The NAV and the share price are not actually synonyms, although they often are used interchangeably. Net asset value (NAV) is a fund's net assets (assets minus liabilities) divided by the number of shares. A party called the [authorized participant](https://www.investopedia.com/terms/a/authorizedparticipant.asp) does its best to keep the share price very close to the NAV, by creating or redeeming shares to align with demand for shares. This must be done so that shareholders experience capital gains or losses that correspond closely to the gains or losses of the fund's holdings.
